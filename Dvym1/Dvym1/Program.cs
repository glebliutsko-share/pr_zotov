    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < MATRIX_LINE; i++)
            {
                ...
                {
                    // Тут мы берем 0 и 6, т.к. нижний предел включается в промежуток, а верхний предел нет. Соответствено у нас получается промежуток [0, 6),
                    // который равен [0; 5] (так то в теории он не равен, т.к. в 1 промежуток так же входят дробные числа больше 5 (например 5.6), но нам пофиг, т.к. у нас нет дробей),
                    // как нам и нужно по условию задачи.
